...
// UPDATE STATUS LOGIC: I-update ang is_online at last_active sa bawat page load
$conn->query("UPDATE users SET is_online = 1, last_active = NOW() WHERE id = '$user_id'");
                ...
                <div class="col-12 col-md-4">
                    <div class="card stat-card shadow-sm p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="bg-warning-subtle text-warning rounded-circle p-3 fs-3" style="width: 60px; height: 60px;"><i class="fa-solid fa-list-check"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="card stat-card shadow-sm p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="bg-primary-subtle text-primary rounded-circle p-3 fs-3" style="width: 60px; height: 60px;"><i class="fa-solid fa-code-commit"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="card stat-card shadow-sm p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-muted small text-uppercase fw-bold">Shared Resources</span>
                                <h2 class="fw-bold text-dark mb-0 mt-1"><?= $renderer->getTotalVaultCount(); ?></h2>
                            </div>
                            <div class="bg-success-subtle text-success rounded-circle p-3 fs-3" style="width: 60px; height: 60px;"><i class="fa-solid fa-box-archive"></i></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-12">
                    <div class="card border shadow-sm mb-4" style="border-radius: 12px; background: white;">
                        <div class="card-header bg-transparent border-bottom p-3">
                            <h6 class="fw-bold text-dark mb-0"><i class="fa-solid fa-thumbtack text-warning me-2"></i>New Assign Tasks</h6>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge <?= ($task['status'] ?? 'Pending Review') === 'Successful' ? 'bg-success' : (($task['status'] ?? '') === 'Rejected' ? 'bg-danger' : 'bg-secondary') ?> rounded px-2 py-1">
                                                        <?= htmlspecialchars($task['status'] ?? 'Pending Review'); ?>
                                                    </span>
                                                </td>
                                            </tr>
                                        <?php endforeach; else: ?>
                    ...
                    <div class="card border shadow-sm" style="border-radius: 12px; background: white;">
                        <div class="card-header bg-transparent border-bottom p-3">
                            <h6 class="fw-bold text-dark mb-0"><i class="fa-solid fa-file-shield text-success me-2"></i>Shared Resources</h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
